...
const TYPE_COLORS={hospital:cssVar('--red','#E07050'),school:cssVar('--blue','#5B9BD5'),hospice:cssVar('--teal','#3DBFA8'),prison:cssVar('--amber','#C4722A'),university:cssVar('--violet','#9B78C8'),gp:cssVar('--green','#4A9B6F'),massacre:cssVar('--massacre','#8B2020')}
